...
def test_largefile():
    ...
    r4900000000  = r_longlong(4900000000)
    r5000000000  = r_longlong(5000000000)
    r5200000000  = r_longlong(5200000000)
    r9900000000  = r_longlong(9900000000)
    r10000000000 = r_longlong(10000000000)
    def does_stuff():
